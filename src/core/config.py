...
class Settings(BaseSettings):
    ...
    # Analysis Weights
    technical_analysis_weight: float = Field(default=0.35, ge=0.0, le=1.0, description="Technical analysis weight")
    economic_analysis_weight: float = Field(default=0.25, ge=0.0, le=1.0, description="Economic analysis weight")
    sentiment_analysis_weight: float = Field(default=0.20, ge=0.0, le=1.0, description="Sentiment analysis weight")
    geopolitical_analysis_weight: float = Field(default=0.10, ge=0.0, le=1.0, description="Geopolitical analysis weight")
    pattern_analysis_weight: float = Field(default=0.10, ge=0.0, le=1.0, description="Pattern analysis weight")
